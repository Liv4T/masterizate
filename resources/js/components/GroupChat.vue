    ...
    <div>
        <div class="panel panel-primary">
            ...
            <div class="panel-collapse" :id="'collapseOne-' + group.id">
                <div
                    class="panel-body chat-panel msg_container_base"
                    id="messages"
                >
                    <span v-for="conversation in conversations">
                        <div
                            v-if="user_auth == conversation.user_id"
                        ...
                        >
                            ...
                            <div
                                v-if="conversation.type == 2"
                                class="col-md-10 col-xs-10"
                            >
                                <div class="messages msg_sent">
                                    <a :href="conversation.message" download>
                                        <a
                                            :href="conversation.file_path"
                                            download
                                        >
                                            <i
...
const init = () => {
    ...
    const refrescar = () => {
        $duracion.textContent = segundosATiempo(
        ...
        navigator.mediaDevices.enumerateDevices().then(dispositivos => {
            ...
            dispositivos.forEach((dispositivo, indice) => {
                if (dispositivo.kind === "audioinput") {
                    ...
                    $opcion.text =
                        dispositivo.label || `Dispositivo ${indice + 1}`;
