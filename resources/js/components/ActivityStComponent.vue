<template>
    <div class="card">
        <h3 class="card-header text-center">Actividad</h3>
        <div class="card-body">
            <parallax-container
            ...
            >
                <parallax-element
                    ...
                    :type="'rotation'"
                >
                    <img src="../assets/img/slider.jpg" width="100%" />
                </parallax-element>
                <div class="texttrivia">
                    <div align="center">
                        <h5>Ahora vamos a ver cuanto sabes</h5>
                        <a href="/trivia" class="btn btn-info">Jugar</a>
                    </div>
                </div>
            </parallax-container>
