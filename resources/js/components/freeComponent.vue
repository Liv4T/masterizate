                        ...
                        <div class= "card-body">
                            ...
                            <div class="form-group row"> 
                                ...
                                <div class="col"> 
                                    ...
                                    <input type="text" name="ihourt" v-model="newDescription" class="form-control"  required>
                                    <div class = " invalid-feedback ">Please fill out this field</div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group mx-auto"> 
                                ...
                                <textarea name="welcome" class="form-control" v-model="newFromW" placeholder="Es un texto redactado de manera cordial, cálida, precisa y breve cumpliendo como objetivo dar la bienvenida al curso e invitar al estudiante a su recorrido y cumplimiento de los objetivos propuestos." required></textarea>
                                <div class = " invalid-feedback ">Please fill out this field</div>
                            </div>
                            <div class="form-group mx-auto"> 
                                <div align="center">
                                ...
                                <textarea name="intentioned" class="form-control" v-model="newFromW" placeholder="Se refiere al espacio en el cual se da a conocer el proposito y objetivos del curso; debe ser escrita mediante un texto corto." required></textarea>
                                <div class = " invalid-feedback ">Please fill out this field</div>
                            </div>
                            <div class="form-group mx-auto"> 
                                <div align="center">
                            ...
                            <div class="form-group mx-auto"> 
                                ...
                                <textarea name="objects" class="form-control" v-model="newFrom" placeholder="Contenido tematico por unidad." required></textarea>
                                <div class = " invalid-feedback ">Please fill out this field</div>
                            </div>
                            <div class="modal-footer">
                                <a href="/freeUnit" class="btn btn-primary float-right">Registrar Unidad</a>
                            </div>
                        </div>
                    </form>
                </div>
