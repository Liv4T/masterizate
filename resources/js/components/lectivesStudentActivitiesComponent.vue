                                ...
                                <div class="card">
                                    ...
                                    >
                                        <form v-if="activity.activity_type=='ENCUESTA_UNICA_RTA'" class="question-module">
                                            <div class="row" v-for="(question, k_q) in activity.module" :key="k_q">
                                                <div class="col">
                                                    <label>{{question.question}}</label>
                                                    <button class="row q-option"  v-for="(option, k_op) in question.content.options" :key="k_op"  v-on:click.prevent="checkOption(question,option,k_q,k_op)"  v-bind:class="{ 'q-option-checked': option.checked }">{{option.content}}</button>                                                
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    methods: {
        ...
        showActivity(activity) {
            ...
            for (var ix_question= 0; ix_question < this.activity.module.length; ix_question++) {
                ...
                let ix_response= this.activity.module[ix_question].response != null && this.activity.module[ix_question].response.response.split('|')[0];
