<template>
    <div class="modal fade" id="modalFoodUpdate" tabindex="-1" role="dialog" aria-labelledby="modalFoodUpdateLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalFoodUpdateLabel">Actualización de Alimentación</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" v-on:click="updateFood">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
