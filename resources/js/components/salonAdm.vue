        ...
        <div class="card text-center">
          ...
          <div class="card-body">
            ...
            <!-- <a
                            ...
                            >Crear materia</a
            >-->
            <a class="btn btn-warning" href="#" v-on:click.prevent="editNames()">Crear usuarios</a>
            <a class="btn btn-warning" href="/importar_adm">Cargar usuarios</a>
            <br />
            <br />
                ...
                <tr>
                  <td>
                    <div id="accordion" class="collapse">
                      <a class="btn btn-warning" href="/docente_adm">Docente</a>
                    </div>
                  </td>
                  <td>
                    <div id="accordion" class="collapse">
                      <a class="btn btn-warning" href="/estudiante_adm">Estudiante</a>
                    </div>
                  </td>
                </tr>
              </tbody>
