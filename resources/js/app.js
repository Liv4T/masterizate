...
Vue.component(
    "semanal-component",
    require("./components/courseSemanalComponet.vue").default
);
Vue.component(
    "semanalact-component",
    require("./components/courseSemanalAct.vue").default
);
Vue.component(
    "list-component",
...
Vue.component(
    "actividad-docente",
    require("./components/ActividadDocente.vue").default
);
Vue.component(
    "sincro-component",
...
Vue.component(
    "quiz-component",
    require("./components/QuizActivity.vue").default
);
Vue.component(
    "complete-component",
    require("./components/CompleteSentence.vue").default
);
...
Vue.component(
    "perfil-docente",
    require("./components/perfildocente.vue").default
);
Vue.component(
    "anuncio-docente",
    require("./components/anunciodocente.vue").default
);
Vue.component(
    "actividadg-docente",
    require("./components/actividadGDocente.vue").default
);
Vue.component(
    "anunciomc-component",
    require("./components/anunciomc.vue").default
);
Vue.component(
    "full-component",
    require("./components/fullCalendar.vue").default
);
Vue.component(
    "redactar-component",
    require("./components/redactar.vue").default
);
Vue.component(
    "vmensaje-component",
    require("./components/vistamensaje.vue").default
);
...
Vue.component(
    "clasesst-component",
    require("./components/clasesSt.vue").default
);
Vue.component(
    "notasd-component",
    require("./components/notasDocente.vue").default
);
Vue.component(
    "actividadvd-component",
    require("./components/actividadVDocente.vue").default
);
Vue.component(
    "clasesd-component",
    require("./components/clasesDocente.vue").default
);
Vue.component(
    "crearc-component",
    require("./components/crearClase.vue").default
);
...
Vue.component(
    "favoritequestion",
    require("./components/FavoriteQuestion").default
);
...
Vue.component(
    "estudiante-adm",
    require("./components/estudianteAdm.vue").default
);
...
Vue.component(
    "planificacion-adm",
    require("./components/planificacionAdm.vue").default
);
...
Vue.component(
    "institu-adm",
    require("./components/institucionesAdm.vue").default
);
Vue.component(
    "cinstitu-adm",
    require("./components/crearInstituciones.vue").default
);
Vue.component(
    "coordinador-adm",
    require("./components/coordinadorAdm.vue").default
);
