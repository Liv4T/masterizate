									...
									<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
										<tr>
											<td align="center" height="70" style="height:70px;">
												<a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://www.uniba.it/immagini/mail-logo.png" alt="" /></a>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
									...
									<div style="line-height: 35px">
										Welcome to the future of <span style="color: #5caad2;">education</span>
									</div>
								</td>
							</tr>
							<tr>
										...
										<tr>
											<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
												...
												<p style="line-height: 24px;margin-bottom:15px;">
													Great news, you are only one step away from completing the process, so you can enjoy exclusive content of our platform,
													don't think about it anymore and be part of this community.
												</p>
												<p style="line-height: 24px; margin-bottom:20px;">
													Please confirm your account to finish the process.
												</p>
													...
													<tr>
														<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
															...
															<div style="line-height: 22px;">
																<a href="" style="color: #ffffff; text-decoration: none;">Confirmation</a>
															</div>
														</td>
													</tr>
													<tr>
												...
												<p style="line-height: 24px">
													Best regards,The Life4teach team.
												</p>
											</td>
										</tr>
									</table>
										...
										<tr>
											<td>
												<table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
													...
													<!-- logo -->
														<td align="left">
															<a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="https://www.uniba.it/immagini/mail-logo.png" alt="" /></a>
														</td>
													</tr>
													<tr>
														<td height="25" style="font-size: 25px; line-height: 25px;">&nbsp;</td>
													...
													<tr>
														<td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
															...
															<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
																Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">cotactenos@dybcatering.com</a>
															</div>
														</td>
													</tr>
												</table>
