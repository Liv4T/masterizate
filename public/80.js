  ...
  methods: {
    ...
    getDataPlanification: function getDataPlanification(id_area, id_classroom) {
      ...
      axios.get(urlsel).then(function (response) {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1747922834_140_16_140_42_4", response.data)));
      });
    },
    botones: function botones(id_achievement, id_planification, collapse_ID) {
      ...
      axios.get("/coursePlanificationObjetives/".concat(id_achievement, "/").concat(id_planification)).then(function (response) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1747922834_148_16_148_58_4", "respuesta", _this3.achievements)));
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1747922834_151_16_151_34_4", error)));
    ...
    valor: function valor(val) {
      ...
      /* eslint-disable */
      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1747922834_164_12_164_28_4", val)));
    },
