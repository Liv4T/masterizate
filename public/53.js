...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getInstitutions: function getInstitutions() {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1795326641_201_8_201_41_4", "Component mounted.")));
    },
    ...
    createInstitution: function createInstitution() {
      ...
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1795326641_248_6_248_35_4", this.fillSection)));
    ...
    ? _c(
        ...
        [
          _c("cinstitu-adm", {
            attrs: {
              back: _vm.showCreate,
              getInstitutions: _vm.getInstitutions
            }
          })
        ],
        1
