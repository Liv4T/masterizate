    ...
    onFlieChange1: function onFlieChange1(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1449467276_259_18_259_44_4", response.data)));
        });
      }
    },
    ...
    videoFile: function videoFile(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1449467276_295_20_295_46_4", response.data)));
    ...
    videoFile1: function videoFile1(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1449467276_320_20_320_46_4", response.data)));
    ...
    videoFile2: function videoFile2(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1449467276_345_20_345_46_4", response.data)));
