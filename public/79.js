...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    botones: function botones(area, classroom, trimestre, collapse_ID) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2584630958_206_12_206_49_4", 'IdCollapse', collapse_ID)));
      ...
      axios.get("/courseCycleAndClass/".concat(area, "/").concat(classroom, "/").concat(trimestre)).then(function (response) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2584630958_211_16_211_40_4", _this3.clases)));
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2584630958_214_16_214_34_4", error)));
    ...
    modalClass: function modalClass(class_array) {
      ...
      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2584630958_250_12_250_37_4", this.classes)));
    }
  }
});
