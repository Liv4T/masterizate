        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                miembros = axios.get('/members').then(function (members) {
                  return members.data;
                });
                users = axios.get('getUsers').then(function (users) {
                  return users.data;
                });
              ...
              case 5:
                ...
                _context2.next = 9;
                return miembros.forEach( /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(m) {
