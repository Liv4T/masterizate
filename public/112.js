...
var init = function init() {
  ...
  if (typeof MediaRecorder === "undefined" || !tieneSoporteUserMedia()) return (
    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("499204522_107_11_109_5_4", "Tu navegador web no cumple los requisitos; por favor, actualiza a un navegador como Firefox o Google Chrome")))
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onResult: function onResult(data) {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("499204522_225_6_225_41_4", "The blob data:", data)));
      /* eslint-disable */


      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("499204522_226_6_226_73_4", "Downloadable audio", window.URL.createObjectURL(data))));
    ...
    comenzarAGrabar: function comenzarAGrabar() {
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        /* eslint-disable */
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("499204522_276_10_276_28_4", error)));
      });
    },
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("499204522_350_19_350_45_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("499204522_355_12_355_40_4", _this4.uploadFile)));
        });
      });
    }
  }
