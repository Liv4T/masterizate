...
Vue.use(vue_clipboard2__WEBPACK_IMPORTED_MODULE_3___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    modalDesign: function modalDesign() {
              ...
              ? _c(
                  "button",
                  {
                    ...
                    attrs: {
                      type: "button",
                      "data-toggle": "modal",
                      "data-target": "#modalDesign"
                    },
                    on: {
                      click: function($event) {
                        return _vm.modalDesign()
                      }
                    }
                  },
                  [
                    ...
                    _c("td", [
                      ...
                      _c(
                        "a",
                        {
                          on: {
                            click: function($event) {
                              return _vm.share(code)
                            }
                          }
                        },
                        [_c("i", { staticClass: "fas fa-share-alt fa-lg" })]
                      )
                    ])
                  ])
                ])
          ...
          _c(
            "div",
            {
              ...
              attrs: {
                ...
                tabindex: "-1",
                role: "dialog",
                "aria-labelledby": "emailShareLabel",
                "aria-hidden": "true"
              }
            },
            [
                    ...
                    _c("div", { staticClass: "modal-footer" }, [
                      ...
                      _c(
                        "button",
                        {
                          staticClass: "btn btn-primary",
                          attrs: { type: "button" },
                          on: { click: _vm.shareCode }
                        },
                        [_vm._v("Enviar código")]
                      )
                    ])
                  ])
                ]
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c("h5", { staticClass: "modal-title" }, [
        _vm._v("Personaliza la plataforma de tus estudiantes")
      ])
    ])
  }
]
