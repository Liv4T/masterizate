...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addTageP: function addTageP(newTag) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1187542924_158_6_158_25_4", newTag)));
    ...
    createAs: function createAs() {
      ...
      this.cestudiante.forEach(function (student) {
        axios.put("/assignParentToStudent/".concat(student.id), {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1187542924_175_10_175_28_4", error)));
        });
      });
