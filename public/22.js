  ...
  methods: {
              ...
              case 0:
                ...
                axios.get("/editGetWeek/".concat(_this4.id_area, "/").concat(_this4.id_classroom, "/").concat(_this4.id_trimestre)).then(function (response) {
                  ...
                  */
                  ...
                  /* eslint-disable */
                  (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1941062456_189_20_189_38_4", error)));
                });
    ...
    getClassToDelete: function getClassToDelete(id_cicle) {
      ...
      axios.get(urls).then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1941062456_208_20_208_38_4", error)));
      });
    },
    ...
    */
    deactivateData: function deactivateData() {
      ...
      axios.put('/test', dataToDeactivate).then(function (response) {
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1941062456_230_20_230_38_4", error)));
      });
    },
    createClass: function createClass(id_module) {
      ...
      /* eslint-disable */
      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1941062456_235_16_235_50_4", 'id_module', id_module)));
