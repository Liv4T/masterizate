  ...
  methods: {
    getClasses: function getClasses() {
      ...
      axios.get('/getAreas').then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3162943933_112_20_112_46_4", response.data)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3162943933_115_20_115_38_4", error)));
      });
    },
