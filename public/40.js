  ...
  methods: {
    getStudentInformation: function getStudentInformation() {
      ...
      return new Promise(function (resolve, reject) {
        axios.get("/api/student/".concat(_this2.id_student)).then(function (response) {
    ...
    getStudentCalifications: function getStudentCalifications() {
      ...
      return new Promise(function (resolve, reject) {
        axios.get("/api/teacher/area/".concat(_this3.id_area, "/classroom/").concat(_this3.id_classroom, "/student/").concat(_this3.id_student)).then(function (response) {
