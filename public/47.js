...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2643422485_133_8_133_41_4", "Component mounted.")));
    ...
    deleteCoord: function deleteCoord(id) {
      if (window.confirm("Desea eliminar este dato?")) {
        axios["delete"]("/destroyUser/".concat(id)).then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2643422485_157_20_157_38_4", error)));
        });
      }
    },
