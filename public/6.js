    ...
    saveNotes: function saveNotes(data) {
      if (this.id_to_update != null) {
        axios.put("/CalLectivesActivities/".concat(this.id_to_update), {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("81545032_132_20_132_43_4", error.data)));
        });
        ...
        axios.post("/CalLectivesActivities", {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("81545032_146_20_146_43_4", error.data)));
        });
      }
