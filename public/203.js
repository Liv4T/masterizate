          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this3.ciclesData = {
                  'id': _this3.id_module,
                  'id_area': _this3.id_area,
                  'id_classroom': _this3.id_classroom,
                  'text': _this3.nameWeekly
                };
                axios.get("/editGetWeek/".concat(_this3.id_area, "/").concat(_this3.id_classroom, "/").concat(_this3.id_trimestre)).then(function (response) {
                  /*
