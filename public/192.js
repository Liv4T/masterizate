  ...
  methods: {
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2531094856_175_19_175_45_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2531094856_180_12_180_40_4", _this3.uploadFile)));
        });
      });
    }
  }
