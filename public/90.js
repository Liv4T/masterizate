          ...
          _c("ul", [
            ...
            _c(
              "a",
              {
                on: {
                  click: function($event) {
                    return _vm.showSection("adminCodesLink")
                  }
                }
              },
              [_vm._m(1)]
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-11 mx-auto", attrs: { id: "tabs" } }, [
        ...
        _vm.activetab === "cyclesClass"
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.activetab === "adminCodesLink"
          ? _c(
              "div",
              [_c("tutor-code-validation", { attrs: { user: _vm.user } })],
              1
            )
          : _vm._e(),
        _vm._v(" "),
        _vm.activetab === "codes"
          ? _c("div", [_c("tutor-code", { attrs: { user: _vm.user } })], 1)
          : _vm._e()
      ])
    ])
  ])
