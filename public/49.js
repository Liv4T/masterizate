  ...
  methods: {
    ...
    updateUser: function updateUser() {
      ...
      axios.put(url, {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3266532993_397_20_397_38_4", error)));
    ...
    emitMessage: function emitMessage(response) {
      ...
      if (message) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3266532993_505_16_505_46_4", message.file_path)));
      }
    },
