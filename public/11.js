...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    savePedagogic: function savePedagogic() {
      ...
      if (!this.data) {
        ...
        axios.post("pedagogic", this.data).then(function (response) {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1191381512_114_20_114_38_4", error)));
        });
      }
    },
    onFileChange: function onFileChange(file) {
      ...
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1191381512_133_12_133_34_4", this.data)));
    }
  }
});
  ...
  methods: {
    savePedagogic: function savePedagogic() {
      ...
      axios.put("pedagogic/".concat(this.id), {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1477851425_122_16_122_34_4", error)));
      });
    }
  }
});
