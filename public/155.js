  ...
  methods: {
    getState: function getState() {
      ...
      axios.get(urlsel).then(function (response) {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2423648635_270_8_270_35_4", _this.myOptions)));
      });
    },
    ...
    mensaje: function mensaje() {
      ...
      if (this.seleccionadoStreaming != 1) {
        this.textoM = "Recomendamos el uso de Google Meet como streaming"; //console.log("aqui");
      } else {
        this.textoM = "";
      }
    },
    ...
    getCity: function getCity() {
      ...
      axios.get(urlse).then(function (response) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2423648635_344_8_344_36_4", _this3.myOptions2)));
      });
    }
  }
});
            ...
            _c(
              ...
              [
                _c(
                  ...
                  [
                    _c("tab-content", { attrs: { title: "Institución" } }, [
