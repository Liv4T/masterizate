...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("100025120_401_8_401_41_4", "Component mounted.")));
  },
  methods: {
    //metodos del CRUD
    ...
    createNames: function createNames() {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("100025120_409_12_409_36_4", "sent form")));

      this.seleccionado = this.$refs.seleccionado.value;
      /* eslint-disable */

      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("100025120_411_12_411_42_4", this.seleccionado)));

      var url = "users_save";
      /* eslint-disable */

      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("100025120_413_12_413_53_4", "send info user url, " + url)));
      /* eslint-disable */


      (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("100025120_414_12_414_57_4", "la foto es: " + this.newPicture)));
    ...
    emitMessage: function emitMessage(response) {
      ...
      if (message) {
        ...
        (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("100025120_552_16_552_46_4", message.file_path)));
      }
    },
