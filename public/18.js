  ...
  methods: {
    ...
    getClassToDelete: function getClassToDelete(id_cicle) {
      ...
      axios.get(urls).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("4062901460_236_20_236_38_4", error)));
      });
    },
    ...
    */
    deactivateData: function deactivateData() {
      ...
      axios.put('/test', dataToDeactivate).then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("4062901460_258_20_258_38_4", error)));
      });
    },
    createClass: function createClass(id_classroom) {
      ...
      /* eslint-disable */
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("4062901460_263_16_263_56_4", 'id_classroom', id_classroom)));
