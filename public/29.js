...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3824424501_112_4_112_26_4", this.user)));
  ...
  methods: {
    ...
    createGroup: function createGroup() {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3824424501_340_6_340_59_4", {
        name: this.nombre,
        users: this.users
