    ...
    savePermission: function savePermission() {
      if (this.id_to_update) {
        axios.put("/permissionPedagogics/".concat(this.id_to_update), {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("143998112_174_24_174_42_4", error)));
        });
      } else {
        axios.post('/permissionPedagogics', {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("143998112_188_24_188_42_4", error)));
        });
      }
    }
  }
