    ...
    saveMotive: function saveMotive() {
      ...
      if (this.idToUpdate == null) {
        axios.post('/motiveAssistants', {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2690138513_97_20_97_38_4", error)));
        });
      } else {
        axios.put("motiveAssistants/".concat(this.idToUpdate), {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2690138513_108_20_108_38_4", error)));
        });
      }
    },
    ...
    deleteMotive: function deleteMotive(id) {
      ...
      if (window.confirm('Está seguro de eliminar este dato?')) {
        axios["delete"]("motiveAssistants/".concat(id)).then(function (response) {
          ...
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2690138513_126_20_126_38_4", error)));
        });
      }
    }
  }
