...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      assistance: false,
      excuse: false
    }, _defineProperty(_ref, "other_motive", false), _defineProperty(_ref, "area_option", []), _defineProperty(_ref, "areaSave", {}), _defineProperty(_ref, "assistants", []), _ref;
  },
  ...
  methods: {
    ...
    updateData: function updateData(data) {
      this.student.id = data.id_student, this.assistance = data.assistance === 1 ? 'on' : 'off', this.excuse = data.excuse === 1 ? 'on' : 'off', this.other_motive = data.other_motive === 1 ? 'on' : 'off', this.motive = data.motive, this.course = data.course;
                ...
                _c(
                  ...
                  _vm._l(_vm.assistants, function(assistant, key) {
                    return _c("tr", { key: key }, [
                      _c("td", [_vm._v(_vm._s(assistant.student_name))]),
                      _vm._v(" "),
                      ...
                      assistant.assistance === 1
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(assistant.created_at.date))]),
                      _vm._v(" "),
                      _c("td", [
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.updateData(assistant)
                              }
                            }
                          },
                          [_vm._v("Actualizar")]
              ...
              _c("div", { staticClass: "modal-body" }, [
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: { value: _vm.other_motive },
                    on: { click: _vm.activeMotive }
                  }),
                  _vm._v(" "),
