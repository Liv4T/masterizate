  ...
  methods: {
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2689448743_212_27_212_53_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2689448743_217_16_217_42_4", _this5.nameFile)));
        });
      });
    }
  }
