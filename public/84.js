...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.getCourseData();
    axios.get("/nameClassroom/".concat(this.id_classroom_selected)).then(function (response) {
      _this.weekly_plan = {
        name: response.data
      };
    });
  ...
  methods: {
    ...
    getCourseData: function getCourseData() {
      ...
      if (this.id_class != 0) {
        axios.get("/api/teacher/module/".concat(this.id_classroom_selected, "/class/").concat(this.id_class)).then(function (response) {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2274346593_459_24_459_48_4", _this3.course)));

          _this3.link_event = response.data.url_class;
          _this3.hour_event = response.data.date_init_class;
          /* eslint-disable */

          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2274346593_462_24_462_48_4", _this3.course)));
    ...
    openActivity: function openActivity(id_activity) {
      ...
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2274346593_493_12_493_38_4", this.activity)));
      /*
                  axios
                      .put(
    ...
    openFeedback: function openFeedback(id_activity) {
      ...
      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2274346593_505_14_505_40_4", this.activity)));
    ...
    saveData: function saveData() {
      ...
      axios.put("/api/teacher/module/".concat(this.id_module, "/class"), this.course).then(function (response) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("2274346593_576_24_576_42_4", error)));
    ...
    onFileChange: function onFileChange(file, item_index) {
      ...
      /* eslint-disable */
      (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("2274346593_632_12_632_35_4", item_index)));
      ...
      if (files.length > 0) {
        ...
        (_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("2274346593_639_16_639_37_4", "evento")));
    ...
    SaveResponseEvent: function SaveResponseEvent(activity) {
      ...
      /* eslint-disable */
      (_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("2274346593_704_12_704_33_4", activity)));
      ...
      axios.put("/api/student/module/".concat(this.id_module, "/class/").concat(this.id_class, "/activity/").concat(activity.id, "/interaction"), activity).then(function (response) {
        ...
        /* eslint-disable */
        (_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("2274346593_715_24_715_42_4", error)));
