...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get(url).then(function (response) {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3978314383_93_6_93_30_4", _this.clases)));
    });
    /* eslint-disable */

    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3978314383_96_4_96_37_4", "Component mounted.")));
  },
  methods: {
