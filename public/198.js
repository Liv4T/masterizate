...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    botones: function botones(area, classroom, trimestre, collapse_ID) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("454769830_179_12_179_49_4", 'IdCollapse', collapse_ID)));
      ...
      axios.get("/viewGetWeek/".concat(area, "/").concat(classroom, "/").concat(trimestre)).then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("454769830_185_16_185_34_4", error)));
    ...
    RequestPermissions: function RequestPermissions(data, curso) {
      ...
      /* eslint-disable */
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("454769830_246_12_250_31_4", {
        cicle: data.text,
      ...
      axios.post('/requestPermission', {
        ...
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("454769830_261_16_261_34_4", error)));
      });
    }
  }
});
