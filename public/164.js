...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    sendMessage: function sendMessage(data, user_id) {
      axios.get("/api/teacher/area/".concat(data.id, "/classroom/").concat(data.id_classroom, "/student/").concat(user_id)).then(function (response) {
