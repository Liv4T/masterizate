        ...
        try{
            ...
            try {
                ...
                $invoice_item = CustomerInvoiceItem::create([
                    ...
                    'unit_value' => $plan_price->tutorial_value,
                    'discount_value' => 0,
                    'tax_percent' => 0,
                    'currency_code' => 'USD',
                    'tax_value' => 0,
                ...
                //el redirect debe llevar a la pantalla de exito que debo copiar de trikele
                //revisar como hacer para traer los datos de la transaccion para poner en la pantalla de exito
                DB::commit();
